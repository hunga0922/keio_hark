void CalcLCStepSize_GHDSS(HA_Complex  A[ARY_NUM_MIC][ARY_NUM_SRC],
		HA_Complex  W[ARY_NUM_SRC][ARY_NUM_MIC],
		HA_Complex  J_LC[ARY_NUM_SRC][ARY_NUM_MIC])
{
	//double fJlcp;
	int num_src=8;
	float fJlcp;
	...
	case LC_CONST_DIAG:
	{
		...
		////	}
		////} //end LC_CONST = DIAG
		for(s=0; s<ARY_NUM_SRC; s++){ // diag(E)
